...
import (
	...
	"github.com/YehorDudukin/go-ethereum/core/state/snapshot"
	...
	"github.com/YehorDudukin/go-ethereum/trie/trienode"
...
func (s *StateDB) StartPrefetcher(namespace string, witness *stateless.Witness) {
	...
	// https://github.com/YehorDudukin/go-ethereum/issues/29880
...
func (s *StateDB) Copy() *StateDB {
	...
	state := &StateDB{
		...
		sharedDiffStorage:    s.sharedDiffStorage.DeepCopy(),
